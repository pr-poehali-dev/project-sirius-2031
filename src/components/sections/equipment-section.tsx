...
const equipment = [
  {
    ...
    specs: "Вес 20 т · Глубина копания 6.7 м",
    direction: "left",
  },
  {
    number: "02",
    ...
    specs: "Г/п 50 т · Высота подъёма 50 м",
    direction: "right",
  },
  {
    number: "03",
    ...
    category: "Землеройная техника",
    specs: "Мощность 168 л.с. · Отвал 3.7 м",
    direction: "left",
  },
  {
    number: "04",
    title: "Телескопический погрузчик JCB 540-200",
    category: "Погрузочная техника",
    specs: "Г/п 4 т · Высота подъёма 20 м",
    direction: "right",
  },
]
